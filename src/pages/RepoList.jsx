...
const RepoList = () => {
  ...
  useEffect(() => {
    axios
      .get(
        `https://api.github.com/users/Samuel-Oyelaran/repos?page=${page}&per_page=9`
      )
      .then((response) => {
        ...
        >
          ...
          >
            <h1 className="primary-text-color secondary-font">
              I am a front-end engineer that is committed to innovative ideas and collaborative
              effort in making the globe space a better place to be. I&apos;m dedicated to learning 
              and passionately showcasing my dexterity in front-end development. 
            </h1>
